 ...
 * shields.io and are best-effort (wickra-exchange is not published yet, so they
...
const PROFILE = 'https://raw.githubusercontent.com/wickra-lib/.github/main/profile/badges/wickra-exchange'

// Source of truth for the footer badge row. Mirrors the wickra-exchange README.
const badges = [
  { alt: 'CI', slug: 'ci', src: `${PROFILE}/ci.svg`, href: 'https://github.com/wickra-lib/wickra-exchange/actions/workflows/ci.yml' },
  { alt: 'CodeQL', slug: 'codeql', src: `${PROFILE}/codeql.svg`, href: 'https://github.com/wickra-lib/wickra-exchange/actions/workflows/codeql.yml' },
  { alt: 'codecov', slug: 'codecov', src: `${PROFILE}/codecov.svg`, href: 'https://codecov.io/gh/wickra-lib/wickra-exchange' },
  { alt: 'GitHub release', slug: 'release', src: 'https://img.shields.io/github/v/release/wickra-lib/wickra-exchange?logo=github&color=green', href: 'https://github.com/wickra-lib/wickra-exchange/releases/latest' },
  { alt: 'crates.io', slug: 'crates', src: 'https://img.shields.io/crates/v/wickra-exchange.svg?logo=rust&color=orange', href: 'https://crates.io/crates/wickra-exchange' },
  { alt: 'PyPI', slug: 'pypi', src: 'https://img.shields.io/pypi/v/wickra-exchange.svg?logo=pypi&color=blue', href: 'https://pypi.org/project/wickra-exchange/' },
  { alt: 'npm', slug: 'npm', src: 'https://img.shields.io/npm/v/wickra-exchange.svg?logo=npm&color=red', href: 'https://www.npmjs.com/package/wickra-exchange' },
  { alt: 'NuGet', slug: 'nuget', src: 'https://img.shields.io/nuget/v/WickraExchange.svg?logo=nuget&color=blue', href: 'https://www.nuget.org/packages/WickraExchange' },
  { alt: 'Maven Central', slug: 'maven', src: 'https://img.shields.io/maven-central/v/org.wickra/wickra-exchange.svg?logo=apachemaven&color=blue', href: 'https://central.sonatype.com/artifact/org.wickra/wickra-exchange' },
  { alt: 'Go module', slug: 'go', src: 'https://img.shields.io/github/v/tag/wickra-lib/wickra-exchange-go.svg?logo=go&logoColor=white&color=00ADD8&label=go', href: 'https://pkg.go.dev/github.com/wickra-lib/wickra-exchange-go' },
  { alt: 'r-universe', slug: 'r-universe', src: 'https://wickra-lib.r-universe.dev/badges/wickra-exchange', href: 'https://wickra-lib.r-universe.dev' },
  { alt: 'License: MIT OR Apache-2.0', slug: 'license', src: `${PROFILE}/license.svg`, href: 'https://github.com/wickra-lib/wickra-exchange#license' },
  { alt: 'OpenSSF Scorecard', slug: 'scorecard', src: `${PROFILE}/scorecard.svg`, href: 'https://scorecard.dev/viewer/?uri=github.com/wickra-lib/wickra-exchange' },
  { alt: 'OpenSSF Best Practices', slug: 'best-practices', src: `${PROFILE}/best-practices.svg`, href: 'https://www.bestpractices.dev/' },
  { alt: 'Build provenance', slug: 'provenance', src: `${PROFILE}/provenance.svg`, href: 'https://github.com/wickra-lib/wickra-exchange/attestations' },
  { alt: 'Verified across 8 languages', slug: 'verified', src: `${PROFILE}/verified.svg`, href: 'https://github.com/wickra-lib/wickra-exchange/tree/main/golden' },
]
...
for (const b of badges) {
  try {
    if (b.slug === 'release') {
      const v = (await ghJson('repos/wickra-lib/wickra-exchange/releases/latest')).tag_name
      b.src = `https://img.shields.io/badge/release-${escBadge(v)}-green?logo=github`
    } else if (b.slug === 'go') {
      const v = (await ghJson('repos/wickra-lib/wickra-exchange-go/tags'))[0]?.name
